...
class OriginalNewFiles:
    ...
    def is_valid_diff(self, diff_obj):
        try:
            ...
            is_minimal = (len(self.file1) - lines_removed) == self.dp[self.m][self.n]
            return current_file == self.file2 and is_minimal
...
diffs = files1_1.all_diff_commands()
print(len(diffs), '\n')
for diff in diffs:
    print(diff, '\n')
